module.exports = async function ({ config, bot, formats }) {
  ...
  const settings = new Map([
    ...
    [SETTING_NAMES.STAFF_REPLY_DM_COLOR, parseColor("#2F3136")],
    [SETTING_NAMES.STAFF_REPLY_THREAD_ENABLED, true],
    [SETTING_NAMES.STAFF_REPLY_THREAD_COLOR, parseColor("#2F3136")],
    [SETTING_NAMES.STAFF_REPLY_DM_TIMESTAMP_ENABLE, true],

    // User -> Staff
    [SETTING_NAMES.USER_REPLY_THREAD_ENABLED, true],
    [SETTING_NAMES.USER_REPLY_THREAD_COLOR, parseColor("#2F3136")],

    // System -> Any
    [SETTING_NAMES.SYSTEM_USER_DM_ENABLED, true],
    [SETTING_NAMES.SYSTEM_USER_DM_COLOR, parseColor("#2F3136")],
    [SETTING_NAMES.SYSTEM_USER_THREAD_ENABLED, true],
    [SETTING_NAMES.SYSTEM_USER_THREAD_COLOR, parseColor("#2F3136")],
    [SETTING_NAMES.SYSTEM_STAFF_ENABLED, true],
    [SETTING_NAMES.SYSTEM_STAFF_COLOR, parseColor("#2F3136")],
